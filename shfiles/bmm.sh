            ...
            for x in {1..1}; do
                for p in {1..1}; do
                    for s in {1..1}; do
                        for m in 2 5; do
                            for g in 1 2; do
                                touch ~/scratch/bmm_test_${y}_${z}_${b}_${x}_${p}_${s}_${m}_${g}.sh
                                f=~/scratch/bmm_test_${y}_${z}_${b}_${x}_${p}_${s}_${m}_${g}.sh
                                echo "#$ -N bmm_testsim">$f
                                echo "#$ -j y">>$f
                                echo "#$ -p -0">>$f
                                echo "#$ -S /bin/bash">>$f
                                echo "#$ -pe smp 2">>$f
                                echo "#$ -o /home/akul/scratch/bmm__${y}_${z}_${b}_${x}_${p}_${s}_${m}_${g}.log">>$f
                                echo "#$ -l h_rt=12:50:00">>$f
                                echo "#$ -l h_vmem=6g">>$f
                                echo "julia /home/akul/sddp_comp/bmm.jl $y $z $x $b $m $g 2 360 10 0 $p $s 5">>$f
                                qsub /home/akul/scratch/bmm_test_${y}_${z}_${b}_${x}_${p}_${s}_${m}_${g}.sh
                                sleep 3
                            done
                        done
                    done
